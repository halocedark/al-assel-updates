...
// function getDatetimeDifference(startDate, endDate = 'current') 
// {
...
// 	{
// 		var currentTime = date_time.format(new Date(), 'HH:mm:ss')
//         endDateTime = CURRENT_DATE + ' ' + currentTime;
//     } 
// 	else 
// 	{
...
//     const diff = new Date(endDateTime - startDateTime);

//     // Create an object to store the difference components
//     const difference = {
...
//     const datediff = TIME_DIFF[locale][largestUnit].replace(':attribute', difference[largestUnit]);

//     // Assign the current difference to the "auto" property
//     difference.auto = datediff;

//     const remainingDatediff = TIME_DIFF_REMAINING[locale][largestUnit].replace(':attribute', difference[largestUnit]);

//     // Assign the current difference to the "auto_remaining" property
//     difference.auto_remaining = remainingDatediff;

//     // Return the difference object
//     return difference;
// }
// function getDatetimeDifference(startDateTimestamp, endDateTimestamp = 'current')
// {
// 	startDateTimestamp = parseTimestamp(startDateTimestamp)
...
//     // Create two Date objects from timestamps
//     const startDateTime = new Date(startDateTimestamp * 1000);
...
// 	{
// 		var currentTime = date_time.format(new Date(), 'HH:mm:ss')
//         endDateTime = parseTimestamp(CURRENT_DATE + ' ' + currentTime);
//     } 
// 	else 
// 	{
//         endDateTime = new Date(endDateTimestamp * 1000);
//     }
